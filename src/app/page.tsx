...
export default function Home() {
  ...
  // return (
  //   <div className="h-full w-full overflow-y-scroll flex flex-col gap-8 pb-3">
  ...
  //       {topVideo.map((item) => (
  //         <div key={item.id} className="h-full g-gray-700 rounded-2xl relative shrink-0 overflow-hidden">
  ...
  //           <div key={movie.id} className="h-[150px] rounded-3xl overflow-hidden relative group cursor-pointer bg-[#21242D]">
  //             <Image
  //               src={movie.image}
  //               alt={movie.title}
  //               fill
